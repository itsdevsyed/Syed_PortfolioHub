...
// Use public folder paths (do NOT import directly)
const bouncing = "/Bouncing.png";
const disney = "/Disney.png";
...
export const links = [
  ...
  { name: "CaseStudies", hash: "#case-studies" },
...
export const experiencesData = [
  {
    ...
    description:
      "As a Software Engineer at Techweaaver Systems Company, I leveraged React.js, MongoDB, and Node.js to create efficient and dynamic web applications, enhancing user experiences.",
  ...
  },
  {
    ...
    description:
      "Designed and developed a responsive and portable college website independently as an academic project, incorporating components still in use in current products.",
